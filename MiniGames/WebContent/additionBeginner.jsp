...
<body>
	...
	<div class="page-header" align="center">
		<h1>Learn Addition For Beginners</h1>
	</div>
	<article>
	...
	<div class="row">
		...
		<center>
			...
			<form method="post" action="ResultController">
				<div class="container">
					<table class="table">
						<p><strong style="color: red"><%=application.getAttribute("playerSessionName") %></strong> Insert your answers and press submit button.</p>
						<thead>
							<tr>
								<th>No:</th>
								<th>Question</th>
						...
						<%
							...
							ResultSet rs = st.executeQuery("Select * FROM addition WHERE mode= 'beginner'");
							int i = 1;
							int pbValue = 10;
							while (rs.next()) {
						%>
	...
	<input type="hidden" name="gameMode" value="beginner" />
